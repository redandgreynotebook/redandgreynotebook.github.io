...
at least i found out what it can do. also, at least i finally [refactored](https://www.example.com). 
...
look how pretty it is! a lot prettier than [last month's answer](https://www.example.com), that's for sure.