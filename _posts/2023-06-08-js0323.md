...
alice and bob play *continuous blackjack*. alice goes first, starting at a score of 0. she can choose to either *hit*, adding a number chosen uniformly at random from $[0, 1]$ to her current score, or *stay*, adding one final number chosen uniformly from $[0, 1]$ before finalizing her current score. she can hit as many times as she wants; however, if her score goes over $1$ before she stays she goes *bust* and her final score will be zero. 
...
source: [jane street puzzles, march 2023](https://www.janestreet.com/puzzles/robot-long-jump-index/)
